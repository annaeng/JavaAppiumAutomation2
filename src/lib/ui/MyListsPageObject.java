...
public class MyListsPageObject extends MainPageObject {
    ...
    private static final String
            FOLDER_BY_NAME_TPL = "//android.widget.TextView[@text='{FOLDER_NAME}']",//By.xpath("//android.widget.TextView[@text='" + name_of_folder + "']"),
            ARTICLE_BY_TITLE_TPL = "//*[@text='{TITLE}']" //By.xpath("//android.widget.TextView[@text='Java (Programmiersprache)']"), //By.xpath("//*[@text='Appium']"), //By.xpath("//*[@text='" + title_of_the_article + "']"),
    ;
    ...
    public void openFolderByName (String name_of_folder) {
        ...
        this.waitForElementPresent(By.xpath(folder_name_xpath), "Cannot find folder by name " + name_of_folder, 10);
        this.waitForElementAndClick(By.xpath(folder_name_xpath), "Cannot find folder by name " + name_of_folder, 10);
    }
    ...
    public void clickOnArticleByTitle (String article_title){
        ...
        String article_xpath = getSavedArticleXpathByTitle(article_title);
        this.waitForElementAndClick(By.xpath(article_xpath), "Cannot get into the article", 10);
    }
